...
typedef struct	s_strace t_ftrace;
...
{
  char		*type;
  void		(*conv)(long long int reg, char res[BUFSIZ], t_ftrace *trace);
}		t_type_map;
...
void	print_syscall(struct user *infos, t_ftrace *trace);
void	print_syscall_ret(int sysnb, struct user *ret, t_ftrace *trace);
...
void	trace_int(long long int reg, char res[BUFSIZ], t_ftrace *trace);
void	trace_uint(long long int reg, char res[BUFSIZ], t_ftrace *trace);
void	trace_chartoile(long long int reg, char res[BUFSIZ], t_ftrace *trace);
void	trace_ptrtoile(long long int reg, char res[BUFSIZ], t_ftrace *trace);
void	trace_ssizet(long long int reg, char res[BUFSIZ], t_ftrace *trace);
void	trace_void(UNSEDP long long int reg, char res[BUFSIZ],
                 UNSEDP t_ftrace *trace);
void	trace_size_t(long long int reg, char res[BUFSIZ], UNSEDP t_ftrace *trace);
